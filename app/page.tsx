  ...
  return (
    <div className="relative  my-10 flex  flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          Deliver instant, accurate medical assistance with our AI-powered voice agents, designed to enhance patient engagement and streamline healthcare services. 24/7
        </motion.p>
